...
def toxic_harmful_content_risk_agent(use_case_summary,search_result):  
    ...
    template="""
            ...
            \n{format_instructions}\n""",
            input_variables=["use_case_summary","search_result"],
            partial_variables={"format_instructions": parser.get_format_instructions()},
        )

    chain = prompt | chat_llm | parser

    agent_results=chain.invoke({"use_case_summary": use_case_summary,"search_result":search_result})
    return agent_results


def incorrect_inaccurate_content_risk_agent(use_case_summary,search_result):  
    prompt = PromptTemplate(
        template="""
...
def propagating_misconceptions_unfaithful_content_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def dissemination_dangerous_information_content_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def fraudulent_suggestions_information_collection_approaches_content_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def manipulative_persuasive_content_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def unethical_use_context_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def unfair_performance_capability_distribution_context_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def influence_operations_manipulate_people_context_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def overreliance_automation_bias_context_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def exploitative_data_sourcing_enrichment(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def false_representation_performance(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def lack_of_accountability_trust_risk_agent(use_case_summary, search_result):
    prompt = PromptTemplate(
        template="""
...
def inadequate_explainability_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def misappropriation_exploitation_of_data_information_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def exposure_to_intellectual_property_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def safety_exposure_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def security_threats_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def privacy_infringement_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def insufficient_safeguards_trust_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def environmental_damage_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def inequality_or_precarity_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def undermine_creative_economies_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def unfair_representation_or_stereotypes_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def discrimination_or_bias_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def defamation_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
...
def pollution_information_ecosystem_societal_risk_agent(use_case_summary,search_result):
    prompt = PromptTemplate(
        template="""
